...
import {Paper , Button ,CloseButton ,Card, Text, Loader, Badge, Group, Container, Center } from '@mantine/core';
    ...
    <div style={{minHeight : '100vh', display : 'grid' , backgroundColor : '#01393A '}}> 
        <Card shadow='sm' padding={"lg"} radius={"md"} withBorder  style={{ borderRadius : '7%' ,backgroundColor : '#0B6F70' , alignItems : 'center', marginLeft : '30%',marginRight : '30%' ,padding : '2%' ,marginBottom:'30%' , marginTop : '10%' , textAlign : 'center', alignContent : 'center'}}>
            <Group style={{display : 'flex' , justifyContent : 'space-between'}}>
                ...
                <Button component={Link} to="/add-report" variant='filled' style={{ backgroundColor : 'white' , marginLeft: '1%', padding: '0.1%', borderRadius: '18%' }}>  <IoIosAddCircle  style={{color : 'darkslateblue'}} size={30} /> </Button>
                <Button onClick={() => handleDelete(report.id)} variant='filled' style={{ backgroundColor:'white' , borderRadius : '18%'}} ><MdDelete style={{color : 'darkslateblue'  }} size={30} /></Button>
            </Group>              
